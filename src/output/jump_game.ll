...
bb10:                                             ; preds = %bb9
  %r117 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r192
...
bb11:                                             ; preds = %bb9
  %r195 = sub i32 %r187, 1
  %r196 = add i32 %r195, 0
  %r124 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r196
...
bb13:                                             ; preds = %bb12
  %r132 = getelementptr i32, ptr %r100, i32 %r199
...
bb15:                                             ; preds = %bb13
  %r140 = getelementptr i32, ptr %r100, i32 %r199
...
bb19:                                             ; preds = %bb18
  ...
  %r212 = add i32 %r211, 0
  %r153 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r212
  %r154 = load i32, ptr %r153, align 4
  %r213 = icmp ne i32 %r154, 0
  br i1 %r213, label %bb21, label %bb22

bb21:                                             ; preds = %bb19
  %r157 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r199
...
bb24:
  ...
  %r224 = add i32 10, 0
  %r225 = call i32 @canJump(ptr %r165, i32 %r224)
  %r226 = add i32 %r225, 0
