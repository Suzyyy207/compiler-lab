...
bb21:                                             ; preds = %bb20
  ...
  %r1769 = getelementptr [5 x %array2D], ptr %r1757, i32 0, i32 %r2443
  %r1770 = getelementptr %array2D, ptr %r1769, i32 0, i32 0
  %r1771 = getelementptr [5 x i32], ptr %r1770, i32 0, i32 %r2450
  store i32 %r2454, ptr %r1771, align 4
...
bb19:                                             ; preds = %bb17
  %r2445 = call i32 @model(ptr %r1757)
