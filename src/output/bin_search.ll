...
bb3:                                              ; preds = %bb2
  %r201 = add i32 %r172, 1
  %r108 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r172
  store i32 %r201, ptr %r108, align 4
  %r202 = add i32 %r172, 1
  %r203 = add i32 %r202, 0
  br label %bb2
...
bb5:                                              ; preds = %bb11, %bb4
  ...
  %r125 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r185
...
bb6:                                              ; preds = %bb8
  ...
  %r193 = add i32 %r192, 0
  %r138 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r193
...
bb7:                                              ; preds = %bb8, %bb5
  %r147 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r185
