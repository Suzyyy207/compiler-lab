...
bb3:                                              ; preds = %bb2
  ...
  %r108 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r107
...
bb4:                                              ; preds = %bb2
  store i32 10, ptr %r115, align 4
  %r116 = call i32 @getint()
  store i32 %r116, ptr %r111, align 4
  %r117 = load i32, ptr %r115, align 4
  %r118 = sub i32 %r117, 1
  store i32 %r118, ptr %r112, align 4
  store i32 0, ptr %r113, align 4
  %r119 = load i32, ptr %r112, align 4
  %r120 = load i32, ptr %r113, align 4
  %r121 = add i32 %r119, %r120
  %r122 = sdiv i32 %r121, 2
  store i32 %r122, ptr %r114, align 4
  br label %bb5

bb5:                                              ; preds = %bb11, %bb4
  %r124 = load i32, ptr %r114, align 4
  %r125 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r124
...
bb8:                                              ; preds = %bb5
  %r129 = load i32, ptr %r113, align 4
  %r130 = load i32, ptr %r112, align 4
  %r131 = icmp slt i32 %r129, %r130
  br i1 %r131, label %bb6, label %bb7

bb6:                                              ; preds = %bb8
  %r132 = load i32, ptr %r112, align 4
  %r133 = load i32, ptr %r113, align 4
  %r134 = add i32 %r132, %r133
  %r135 = sdiv i32 %r134, 2
  store i32 %r135, ptr %r114, align 4
  %r136 = load i32, ptr %r111, align 4
  %r137 = load i32, ptr %r114, align 4
  %r138 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r137
  %r139 = load i32, ptr %r138, align 4
  %r140 = icmp slt i32 %r136, %r139
  br i1 %r140, label %bb9, label %bb10

bb9:                                              ; preds = %bb6
  %r141 = load i32, ptr %r114, align 4
  %r142 = sub i32 %r141, 1
  store i32 %r142, ptr %r112, align 4
  br label %bb11

bb10:                                             ; preds = %bb6
  %r143 = load i32, ptr %r114, align 4
  %r144 = add i32 %r143, 1
  store i32 %r144, ptr %r113, align 4
  br label %bb11
...
bb7:                                              ; preds = %bb8, %bb5
  %r145 = load i32, ptr %r111, align 4
  %r146 = load i32, ptr %r114, align 4
  %r147 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r146
  %r148 = load i32, ptr %r147, align 4
  %r149 = icmp eq i32 %r145, %r148
  br i1 %r149, label %bb12, label %bb13

bb12:                                             ; preds = %bb7
  %r150 = load i32, ptr %r111, align 4
...
bb13:                                             ; preds = %bb7
  ...
  %r152 = load i32, ptr %r111, align 4
  %r153 = load i32, ptr %r111, align 4
  call void @putint(i32 %r153)
  br label %bb14

bb14:                                             ; preds = %bb13, %bb12
  store i32 10, ptr %r111, align 4
  %r154 = load i32, ptr %r111, align 4
  %r155 = load i32, ptr %r111, align 4
