...
bb8:                                              ; preds = %bb7
  %r176 = sub i32 %r174, 1
  %r177 = add i32 %r176, 0
  %r124 = getelementptr i32, ptr %r100, i32 %r177
  %r125 = load i32, ptr %r124, align 4
  %r127 = getelementptr i32, ptr %r100, i32 %r174
  store i32 %r125, ptr %r127, align 4
  %r130 = getelementptr i32, ptr %r100, i32 %r171
  store i32 %r169, ptr %r130, align 4
  %r178 = sub i32 %r174, 1
  %r179 = add i32 %r178, 0
  br label %bb7
...
bb10:
  ...
  %r133 = alloca [11 x i32], align 4
  %r134 = getelementptr [11 x i32], ptr %r133, i32 0, i32 0
  store i32 1, ptr %r134, align 4
  %r135 = getelementptr [11 x i32], ptr %r133, i32 0, i32 1
  store i32 3, ptr %r135, align 4
  %r136 = getelementptr [11 x i32], ptr %r133, i32 0, i32 2
  store i32 4, ptr %r136, align 4
  %r137 = getelementptr [11 x i32], ptr %r133, i32 0, i32 3
  store i32 7, ptr %r137, align 4
  %r138 = getelementptr [11 x i32], ptr %r133, i32 0, i32 4
  store i32 8, ptr %r138, align 4
  %r139 = getelementptr [11 x i32], ptr %r133, i32 0, i32 5
  store i32 11, ptr %r139, align 4
  %r140 = getelementptr [11 x i32], ptr %r133, i32 0, i32 6
  store i32 13, ptr %r140, align 4
  %r141 = getelementptr [11 x i32], ptr %r133, i32 0, i32 7
  store i32 18, ptr %r141, align 4
  %r142 = getelementptr [11 x i32], ptr %r133, i32 0, i32 8
  store i32 56, ptr %r142, align 4
  %r143 = getelementptr [11 x i32], ptr %r133, i32 0, i32 9
  store i32 78, ptr %r143, align 4
  %r185 = add i32 0, 0
  %r186 = add i32 0, 0
  %r187 = add i32 0, 0
  %r188 = call i32 @getint()
  %r189 = add i32 %r188, 0
  %r190 = call i32 @insert(ptr %r133, i32 %r189)
  %r191 = add i32 %r190, 0
  br label %bb11

bb11:                                             ; preds = %bb12, %bb10
  %r192 = phi i32 [ %r187, %bb10 ], [ %r197, %bb12 ]
  %r150 = load i32, ptr @N, align 4
  %r193 = icmp slt i32 %r192, %r150
  br i1 %r193, label %bb12, label %bb13

bb12:                                             ; preds = %bb11
  %r153 = getelementptr [11 x i32], ptr %r133, i32 0, i32 %r192
