...
bb8:                                              ; preds = %bb7
  ...
  %r242 = sub i32 %r241, 1
  %r243 = add i32 %r242, 0
  %r124 = getelementptr [9 x i32], ptr %r109, i32 0, i32 %r243
...
bb11:                                             ; preds = %bb10
  ...
  %r237 = add i32 %r236, 0
  %r136 = getelementptr [9 x i32], ptr %r109, i32 0, i32 %r237
...
bb17:                                             ; preds = %bb16
  ...
  %r229 = add i32 %r228, 1
  %r230 = add i32 %r229, 0
  %r164 = getelementptr [9 x i32], ptr %r109, i32 0, i32 %r226
  %r165 = load i32, ptr %r164, align 4
  %r167 = getelementptr [9 x i32], ptr %r109, i32 0, i32 %r230
  %r168 = load i32, ptr %r167, align 4
  %r231 = add i32 %r165, %r168
  %r171 = getelementptr [9 x i32], ptr %r109, i32 0, i32 %r222
  store i32 %r231, ptr %r171, align 4
  %r232 = sub i32 %r215, 1
  %r233 = add i32 %r232, 0
  br label %bb16
