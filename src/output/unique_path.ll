...
bb7:                                              ; preds = %bb8, %bb5
  %r115 = load i32, ptr %r110, align 4
  %r116 = load i32, ptr %r101, align 4
  %r117 = icmp slt i32 %r115, %r116
  br i1 %r117, label %bb8, label %bb9

bb8:                                              ; preds = %bb7
  %r118 = load i32, ptr %r110, align 4
  %r119 = mul i32 %r118, 3
  %r120 = load i32, ptr %r103, align 4
  %r121 = add i32 %r119, %r120
  %r122 = sub i32 %r121, 1
  store i32 %r122, ptr %r112, align 4
  %r123 = load i32, ptr %r112, align 4
  %r124 = getelementptr [9 x i32], ptr %r109, i32 0, i32 %r123
  store i32 1, ptr %r124, align 4
  %r125 = load i32, ptr %r110, align 4
  %r126 = add i32 %r125, 1
  store i32 %r126, ptr %r110, align 4
  br label %bb7
...
bb10:                                             ; preds = %bb11, %bb9
  %r127 = load i32, ptr %r110, align 4
...
bb11:                                             ; preds = %bb10
  ...
  %r131 = sub i32 %r130, 1
  %r132 = mul i32 %r131, 3
  %r133 = load i32, ptr %r110, align 4
  %r134 = add i32 %r132, %r133
  store i32 %r134, ptr %r112, align 4
  %r135 = load i32, ptr %r112, align 4
  %r136 = getelementptr [9 x i32], ptr %r109, i32 0, i32 %r135
  store i32 1, ptr %r136, align 4
  %r137 = load i32, ptr %r110, align 4
  %r138 = add i32 %r137, 1
  store i32 %r138, ptr %r110, align 4
  br label %bb10

bb12:                                             ; preds = %bb10
  %r139 = load i32, ptr %r101, align 4
  %r140 = sub i32 %r139, 2
  store i32 %r140, ptr %r110, align 4
  br label %bb13

bb13:                                             ; preds = %bb18, %bb12
  %r141 = load i32, ptr %r110, align 4
  %r142 = sub i32 0, 1
  %r143 = icmp sgt i32 %r141, %r142
  br i1 %r143, label %bb14, label %bb15

bb14:                                             ; preds = %bb13
  %r144 = load i32, ptr %r103, align 4
  %r145 = sub i32 %r144, 2
  store i32 %r145, ptr %r111, align 4
  br label %bb16

bb16:                                             ; preds = %bb17, %bb14
  %r146 = load i32, ptr %r111, align 4
  %r147 = sub i32 0, 1
  %r148 = icmp sgt i32 %r146, %r147
  br i1 %r148, label %bb17, label %bb18

bb17:                                             ; preds = %bb16
  %r149 = load i32, ptr %r110, align 4
  %r150 = mul i32 %r149, 3
  %r151 = load i32, ptr %r111, align 4
  %r152 = add i32 %r150, %r151
  store i32 %r152, ptr %r112, align 4
  %r153 = load i32, ptr %r110, align 4
  %r154 = add i32 %r153, 1
  %r155 = mul i32 %r154, 3
  %r156 = load i32, ptr %r111, align 4
  %r157 = add i32 %r155, %r156
  store i32 %r157, ptr %r113, align 4
  %r158 = load i32, ptr %r110, align 4
  %r159 = mul i32 %r158, 3
  %r160 = load i32, ptr %r111, align 4
  %r161 = add i32 %r159, %r160
  %r162 = add i32 %r161, 1
  store i32 %r162, ptr %r114, align 4
  %r163 = load i32, ptr %r113, align 4
  %r164 = getelementptr [9 x i32], ptr %r109, i32 0, i32 %r163
  %r165 = load i32, ptr %r164, align 4
  %r166 = load i32, ptr %r114, align 4
  %r167 = getelementptr [9 x i32], ptr %r109, i32 0, i32 %r166
  %r168 = load i32, ptr %r167, align 4
  %r169 = add i32 %r165, %r168
  %r170 = load i32, ptr %r112, align 4
  %r171 = getelementptr [9 x i32], ptr %r109, i32 0, i32 %r170
  store i32 %r169, ptr %r171, align 4
  %r172 = load i32, ptr %r111, align 4
  %r173 = sub i32 %r172, 1
  store i32 %r173, ptr %r111, align 4
  br label %bb16

bb18:                                             ; preds = %bb16
  %r174 = load i32, ptr %r110, align 4
  %r175 = sub i32 %r174, 1
  store i32 %r175, ptr %r110, align 4
  br label %bb13

bb15:                                             ; preds = %bb13
  %r176 = getelementptr [9 x i32], ptr %r109, i32 0, i32 0
...
bb19:
  ...
  store i32 3, ptr %r179, align 4
  %r180 = load i32, ptr %r179, align 4
  %r181 = load i32, ptr %r179, align 4
  %r182 = call i32 @uniquePaths(i32 %r180, i32 %r181)
  store i32 %r182, ptr %r178, align 4
  %r183 = load i32, ptr %r178, align 4
  ret i32 %r183
}
