...
bb6:                                              ; preds = %bb5
  %r118 = load i32, ptr %r112, align 4
  %r119 = call i32 @mod(i32 %r118, i32 10)
  %r120 = load i32, ptr %r114, align 4
  %r121 = getelementptr [4 x i32], ptr %r113, i32 0, i32 %r120
  store i32 %r119, ptr %r121, align 4
  %r122 = load i32, ptr %r112, align 4
  %r123 = sdiv i32 %r122, 10
  store i32 %r123, ptr %r112, align 4
  %r124 = load i32, ptr %r114, align 4
  %r125 = add i32 %r124, 1
  store i32 %r125, ptr %r114, align 4
  br label %bb5

bb7:                                              ; preds = %bb5
  %r127 = getelementptr [4 x i32], ptr %r113, i32 0, i32 0
  %r128 = load i32, ptr %r127, align 4
  %r129 = getelementptr [4 x i32], ptr %r113, i32 0, i32 3
  %r130 = load i32, ptr %r129, align 4
  %r131 = icmp eq i32 %r128, %r130
  br i1 %r131, label %bb11, label %bb9

bb11:                                             ; preds = %bb7
  %r132 = getelementptr [4 x i32], ptr %r113, i32 0, i32 1
  %r133 = load i32, ptr %r132, align 4
  %r134 = getelementptr [4 x i32], ptr %r113, i32 0, i32 2
...
bb10:                                             ; preds = %bb9, %bb8
  %r137 = load i32, ptr %r115, align 4
  ret i32 %r137
}
...
bb12:
  ...
  store i32 1221, ptr %r138, align 4
  %r139 = alloca i32, align 4
  %r140 = load i32, ptr %r138, align 4
  %r141 = call i32 @palindrome(i32 %r140)
  store i32 %r141, ptr %r139, align 4
  %r142 = load i32, ptr %r139, align 4
  %r143 = icmp eq i32 %r142, 1
  br i1 %r143, label %bb13, label %bb14

bb13:                                             ; preds = %bb12
  %r144 = load i32, ptr %r138, align 4
...
bb14:                                             ; preds = %bb12
  ...
  %r146 = load i32, ptr %r139, align 4
  %r147 = load i32, ptr %r139, align 4
  call void @putint(i32 %r147)
  br label %bb15

bb15:                                             ; preds = %bb14, %bb13
  store i32 10, ptr %r139, align 4
  %r148 = load i32, ptr %r139, align 4
  %r149 = load i32, ptr %r139, align 4
