...
bb3:                                              ; preds = %bb2
  ...
  %r108 = getelementptr [32768 x i32], ptr @program, i32 0, i32 %r107
...
bb15:                                             ; preds = %bb14
  ...
  %r137 = add i32 %r136, 1
  %r138 = load i32, ptr @ptr, align 4
  %r139 = getelementptr [65536 x i32], ptr @tape, i32 0, i32 %r138
...
bb18:                                             ; preds = %bb17
  ...
  %r145 = sub i32 %r144, 1
  %r146 = load i32, ptr @ptr, align 4
  %r147 = getelementptr [65536 x i32], ptr @tape, i32 0, i32 %r146
...
bb24:                                             ; preds = %bb23
  %r155 = call i32 @getch()
  %r156 = load i32, ptr @ptr, align 4
  %r157 = getelementptr [65536 x i32], ptr @tape, i32 0, i32 %r156
  store i32 %r155, ptr %r157, align 4
  br label %bb26
...
bb26:                                             ; preds = %bb25, %bb24
  %r159 = load i32, ptr %r114, align 4
  %r160 = icmp eq i32 %r159, 93
  br i1 %r160, label %bb30, label %bb28

bb30:                                             ; preds = %bb26
  %r161 = load i32, ptr @ptr, align 4
  %r162 = getelementptr [65536 x i32], ptr @tape, i32 0, i32 %r161
  %r163 = load i32, ptr %r162, align 4
  %r164 = icmp ne i32 %r163, 0
  br i1 %r164, label %bb27, label %bb28
...
bb31:                                             ; preds = %bb39, %bb27
  %r165 = load i32, ptr %r115, align 4
  %r166 = icmp sgt i32 %r165, 0
  br i1 %r166, label %bb32, label %bb33

bb32:                                             ; preds = %bb31
  %r167 = load i32, ptr %r116, align 4
  %r168 = sub i32 %r167, 1
  store i32 %r168, ptr %r116, align 4
  %r169 = load i32, ptr %r116, align 4
  %r170 = getelementptr i32, ptr %r113, i32 %r169
  %r171 = load i32, ptr %r170, align 4
  store i32 %r171, ptr %r114, align 4
  %r172 = load i32, ptr %r114, align 4
  %r173 = icmp eq i32 %r172, 91
  br i1 %r173, label %bb34, label %bb35

bb34:                                             ; preds = %bb32
  %r174 = load i32, ptr %r115, align 4
  %r175 = sub i32 %r174, 1
  store i32 %r175, ptr %r115, align 4
  br label %bb36
...
bb36:                                             ; preds = %bb35, %bb34
  %r176 = load i32, ptr %r114, align 4
  %r177 = icmp eq i32 %r176, 93
  br i1 %r177, label %bb37, label %bb38

bb37:                                             ; preds = %bb36
  %r178 = load i32, ptr %r115, align 4
  %r179 = add i32 %r178, 1
  store i32 %r179, ptr %r115, align 4
  br label %bb39
...
bb29:                                             ; preds = %bb28, %bb33
  ...
  %r181 = add i32 %r180, 1
  store i32 %r181, ptr %r116, align 4
  br label %bb6
...
bb40:
  ...
  %r182 = getelementptr [32768 x i32], ptr @program, i32 0, i32 0
  call void @interpret(ptr %r182)
