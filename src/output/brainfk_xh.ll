...
bb3:                                              ; preds = %bb2
  %r192 = call i32 @getch()
  %r108 = getelementptr [32768 x i32], ptr @program, i32 0, i32 %r190
  store i32 %r192, ptr %r108, align 4
  %r193 = add i32 %r190, 1
  %r194 = add i32 %r193, 0
  br label %bb2

bb4:                                              ; preds = %bb2
  %r112 = getelementptr [32768 x i32], ptr @program, i32 0, i32 %r190
...
bb9:                                              ; preds = %bb7
  ...
  %r235 = add i32 %r126, 1
  store i32 %r235, ptr @ptr, align 4
  br label %bb11
...
bb12:                                             ; preds = %bb11
  ...
  %r234 = sub i32 %r130, 1
  store i32 %r234, ptr @ptr, align 4
  br label %bb14
...
bb15:                                             ; preds = %bb14
  ...
  store i32 %r233, ptr %r139, align 4
  br label %bb17
...
bb18:                                             ; preds = %bb17
  ...
  store i32 %r232, ptr %r147, align 4
  br label %bb20
...
bb24:                                             ; preds = %bb23
  ...
  store i32 %r231, ptr %r157, align 4
  br label %bb26
...
bb31:                                             ; preds = %bb39, %bb27
  %r217 = phi i32 [ %r202, %bb27 ], [ %r221, %bb39 ]
  %r218 = phi i32 [ %r216, %bb27 ], [ %r226, %bb39 ]
  %r219 = icmp sgt i32 %r218, 0
  br i1 %r219, label %bb32, label %bb33

bb32:                                             ; preds = %bb31
  %r220 = sub i32 %r217, 1
  %r221 = add i32 %r220, 0
  %r170 = getelementptr i32, ptr %r113, i32 %r221
...
bb36:                                             ; preds = %bb35, %bb34
  %r224 = phi i32 [ %r230, %bb34 ], [ %r218, %bb35 ]
...
bb29:                                             ; preds = %bb28, %bb33
  %r212 = phi i32 [ %r217, %bb33 ], [ %r202, %bb28 ]
  %r213 = add i32 %r212, 1
  %r214 = add i32 %r213, 0
  br label %bb6
