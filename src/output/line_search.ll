...
bb5:                                              ; preds = %bb11, %bb4
  %r126 = load i32, ptr %r100, align 4
...
bb6:                                              ; preds = %bb8
  %r130 = load i32, ptr %r100, align 4
  %r131 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r130
  %r132 = load i32, ptr %r131, align 4
  %r133 = load i32, ptr %r111, align 4
  %r134 = icmp eq i32 %r132, %r133
  br i1 %r134, label %bb9, label %bb10

bb9:                                              ; preds = %bb6
  store i32 1, ptr %r123, align 4
  %r135 = load i32, ptr %r100, align 4
  store i32 %r135, ptr %r124, align 4
  br label %bb11
...
bb11:                                             ; preds = %bb10, %bb9
  %r136 = load i32, ptr %r100, align 4
  %r137 = add i32 %r136, 1
  store i32 %r137, ptr %r100, align 4
  br label %bb5
...
bb12:                                             ; preds = %bb7
  %r140 = load i32, ptr %r124, align 4
  %r141 = load i32, ptr %r124, align 4
  call void @putint(i32 %r141)
  br label %bb14

bb13:                                             ; preds = %bb7
  store i32 0, ptr %r111, align 4
  %r142 = load i32, ptr %r111, align 4
