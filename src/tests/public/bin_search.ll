...
bb5:
  %r183 = phi i32 [ %r182, %bb4 ], [ %r193, %bb11 ]
  %r184 = phi i32 [ %r179, %bb4 ], [ %r195, %bb11 ]
  %r185 = phi i32 [ %r178, %bb4 ], [ %r196, %bb11 ]
  %r125 = getelementptr [10 x i32 ], [10 x i32 ]* %r102, i32 0, i32 %r183
  %r126 = load i32, i32* %r125
  %r186 = icmp ne i32 %r126, %r176
  br i1 %r186, label %bb8, label %bb7

bb8:
  %r190 = icmp slt i32 %r184, %r185
  br i1 %r190, label %bb6, label %bb7

bb6:
  %r191 = add i32 %r185, %r184
...
bb11:
  %r195 = phi i32 [ %r184, %bb9 ], [ %r198, %bb10 ]
  %r196 = phi i32 [ %r200, %bb9 ], [ %r185, %bb10 ]
  br label %bb5

bb7:
  %r147 = getelementptr [10 x i32 ], [10 x i32 ]* %r102, i32 0, i32 %r183
